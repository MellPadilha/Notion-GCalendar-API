...
async function createPage(body) {
  ...
  // const data = await newPageData["data"];
  // const pageID = await data["id"];
  // const contentId = await data["id"];
}
